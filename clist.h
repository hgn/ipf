...
#define	CLIST_FAILURE -1
#define	CLIST_SUCCESS  0
...
int list_for_each2(struct list *list, int (*func)(void *data, void *userdata, void *userdate2), void *userdata, void *userdate2);
